...
public class signUpOne extends JFrame implements ActionListener{
    ...
    signUpOne(){
        ...
        Formno.setBounds(220,10,600,30);
        add(Formno);

//        Personal Details
        JLabel personalDetails=new JLabel("Page 1:  Personal Details");
        personalDetails.setFont(new Font("Raleway", Font.BOLD,22));
        personalDetails.setBounds(290,50,400,25);
        add(personalDetails);

//        Name
        JLabel name=new JLabel("Name: ");
        name.setFont(new Font("Raleway", Font.BOLD,20));
        name.setBounds(100,95,200,30);
        add(name);

//        Name Textfield
        nameTextField=new JTextField("");
        nameTextField.setFont(new Font("Raleway", Font.BOLD,22));
        nameTextField.setBounds(300,95,400,30);
        add(nameTextField);
...
//        Fathers Name
        ...
        fname.setBounds(100,145,200,30);
        add(fname);

//        Fathers Name Textfield
        fatherTextField=new JTextField();
        fatherTextField.setFont(new Font("Raleway", Font.BOLD,22));
        fatherTextField.setBounds(300,145,400,30);
        add(fatherTextField);

//        Date of Birth
        JLabel dob=new JLabel("Date of Birth: ");
        dob.setFont(new Font("Raleway", Font.BOLD,20));
        dob.setBounds(100,195,200,30);
        add(dob);

//        Calender for Dates
        dobc=new JDateChooser();
        dobc.setBounds(300,195,400,30);
        add(dobc);

//        Gender
        JLabel gender=new JLabel("Gender: ");
        gender.setFont(new Font("Raleway", Font.BOLD,20));
        gender.setBounds(100,245,200,30);
        add(gender);

//        Male Radiobutton
        male= new JRadioButton("Male");
        male.setBounds(300,245,60,30);
        male.setBackground(Color.WHITE);
        add(male);

//        Female Redio Button
        female= new JRadioButton("Female");
        female.setBounds(450,245,120,30);
...
//        Email
        ...
        email.setBounds(100,295,200,30);
        add(email);
...
//        Marital Status
        ...
        marital.setBounds(100,345,200,30);
        add(marital);

//        Married Radiobutton
        married= new JRadioButton("Married");
        married.setBounds(300,345,120,30);
        married.setBackground(Color.WHITE);
        add(married);

//        Unmarried Redio Button
        unmarried= new JRadioButton("Unmarried");
        unmarried.setBounds(450,345,120,30);
        unmarried.setBackground(Color.WHITE);
        add(unmarried);

        //        others Redio Button
        others= new JRadioButton("Others");
        others.setBounds(600,345,120,30);
...
//        ADdress TextField
        ...
        addressTextField.setBounds(300,395,400,30);
...
//        State
        ...
        state.setBounds(100,495,200,30);
        add(state);

//        State TextField
        stateTextField=new JTextField();
        stateTextField.setFont(new Font("Raleway", Font.BOLD,22));
        stateTextField.setBounds(300,495,400,30);
        add(stateTextField);

//        pincode
        JLabel pincode=new JLabel("Pin Code: ");
        pincode.setFont(new Font("Raleway", Font.BOLD,20));
        pincode.setBounds(100,545,200,30);
        add(pincode);

//        Pincode Textfield
        pinTextField=new JTextField();
        pinTextField.setFont(new Font("Raleway", Font.BOLD,22));
        pinTextField.setBounds(300,545,400,30);
        add(pinTextField);
...
//        Button
        ...
        button.setBounds(100,595,80,30);
        add(button);
